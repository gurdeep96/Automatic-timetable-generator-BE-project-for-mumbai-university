        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    ...
                    <?php
                    	include "connect.php";
						$query = "SELECT * FROM classroom  WHERE department='{$_SESSION['de']}'"; //You don't need a ; like you do in SQL
						$result = mysqli_query($connect,$query);
						echo "<font size='4' face='Arial'>";
						echo "<table id='tabsub' border='2'>"; // start a table tag in the HTML
						echo "<tr><th>Room Name</th><th>Shortcode</th><th>Capacity</th><th>Room Type</th><th></th><th></th></tr>";
						while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
						echo "<tr><td>" . $row['crnm'] . "</td><td>" . $row['crsn'] . "</td><td><center>" . $row['crcp'] . "</center></td><td><center>" . $row['crtype'] . "</center></td><td><center><a id='editbut' href='editcls.php?edit=".$row['crsn']."'>Edit</a></center></td><td><center><a id='delbut' href=delcls.php?crsn=".$row['crsn'].">Delete</a></center></td></tr>";  
						}
					...
					?>
                    <br>
                    <input type="submit" style="background-color: darkslategray;color: white" class="btn btn-primary" value="GO BACK" name="back" onclick="window.location.href='classroom.php'" class="txt2">
                </div>
            </div>
        </div>
    </div>
