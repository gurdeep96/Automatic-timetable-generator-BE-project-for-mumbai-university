...
<body onload="window.print()">
   ...
   <div id="hi">
        <div id="masterContent">
              <br>		
						<h1 align="center" id ="seheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                          <h4 id ="sehead" align="center" style="display:none;"><?php echo "SE ".strtoupper($_SESSION['de']); if($_SESSION['eo']=='even') echo ' sem4'; else echo ' sem3';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="semon">
                          ...
                          <h1 align="center" id ="teheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="tehead" align="center" style="display:none;" ><?php echo "TE ".strtoupper($_SESSION['de']); if($_SESSION['eo']=='even') echo ' sem6'; else echo ' sem5';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="temon">
						  ...
						  <h1 align="center" id="beheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="behead" align="center" style="display:none;" ><?php echo "BE ".strtoupper($_SESSION['de']); if($_SESSION['eo']=='even') echo ' sem8'; else echo ' sem7';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="bemon">
						  ...
						  <h1 align="center" id ="semaheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="semahead" align="center" style="display:none;" ><?php echo "SE ".strtoupper($_SESSION['de'])." A"; if($_SESSION['eo']=='even') echo ' sem4'; else echo ' sem3';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="semamon">
						  ...
						  <h1 align="center" id ="temaheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="temahead" align="center" style="display:none;" ><?php echo "TE ".strtoupper($_SESSION['de'])." A"; if($_SESSION['eo']=='even') echo ' sem6'; else echo ' sem5';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="temamon">
                          ...
                          <tr id="temafri">
						   ...
						   <h1 align="center" id ="bemaheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="bemahead" align="center"  style="display:none;"><?php echo "BE ".strtoupper($_SESSION['de'])." A"; if($_SESSION['eo']=='even') echo ' sem8'; else echo ' sem7';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="bemamon">
						  ...
						  <h1 align="center" id ="sembheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="sembhead" align="center" style="display:none;" ><?php echo "SE ".strtoupper($_SESSION['de'])." B"; if($_SESSION['eo']=='even') echo ' sem4'; else echo ' sem3';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="sembmon">
						  ...
						  <h1 align="center" id ="tembheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="tembhead" align="center"  style="display:none;"><?php echo "TE ".strtoupper($_SESSION['de'])." B"; if($_SESSION['eo']=='even') echo ' sem6'; else echo ' sem5';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="tembmon">
						  ...
						  <h1 align="center" id ="bembheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id="bembhead" align="center" style="display:none;"><?php echo "BE ".strtoupper($_SESSION['de'])." B"; if($_SESSION['eo']=='even') echo ' sem8'; else echo ' sem7';?></h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="bembmon">
						  ...
						  <h1 align="center" id ="feaheaddon" style="display:none;" >Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="feahead" align="center"  style="display:none;"><?php echo "FE DIV-A"; if($_SESSION['eo']=='even') echo ' sem2'; else echo ' sem1';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="feamon">
						  ...
						  <h1 align="center" id ="febheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="febhead" align="center"  style="display:none;"><?php echo "FE DIV-B"; if($_SESSION['eo']=='even') echo ' sem2'; else echo ' sem1';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="febmon">
						  ...
						  <h1 align="center" id ="fecheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="fechead" align="center"  style="display:none;"><?php echo "FE DIV-C"; if($_SESSION['eo']=='even') echo ' sem2'; else echo ' sem1';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="fecmon">
						  ...
						  <h1 align="center" id ="fedheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="fedhead" align="center" style="display:none;" ><?php echo "FE DIV-D"; if($_SESSION['eo']=='even') echo ' sem2'; else echo ' sem1';?> </h4>
                          <br>
                        ...
                        <tr>
                         ...
                         <tr id="feamon">
						  ...
						  <h1 align="center" id ="feeheaddon" style="display:none;">Don Bosco Institute of Technology</h1>
                        
                          <h4 id ="feehead" align="center"  style="display:none;"><?php echo "FE DIV-E"; if($_SESSION['eo']=='even') echo ' sem2'; else echo ' sem1';?> </h4>
                          <br>
...
if($_SESSION['de']=="extc" || $_SESSION['de']=="EXTC" || $_SESSION['de']=="it" || $_SESSION['de']=="IT" || $_SESSION['de']=="comps" || $_SESSION['de']=="COMPS"){
  ?>
  <script>document.getElementById("seheaddon").style.display="block";</script>
  <script>document.getElementById("sehead").style.display="block";</script>
  <script>document.getElementById("teheaddon").style.display="block";</script>
  <script>document.getElementById("tehead").style.display="block";</script>
  <script>document.getElementById("beheaddon").style.display="block";</script>
  ...
  if($_SESSION['de']=="fe" || $_SESSION['de']=="FE"){
    ...
    <script>document.getElementById("feaheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("febheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("fecheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("fedheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("feeheaddon").style.display="block";</script>
  ...
  if($_SESSION['de']=="mech" || $_SESSION['de']=="MECH"){
    ...
    <script>document.getElementById("semaheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("temaheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("bemaheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("sembheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("tembheaddon").style.display="block";</script>
    ...
    <script>document.getElementById("bembheaddon").style.display="block";</script>
