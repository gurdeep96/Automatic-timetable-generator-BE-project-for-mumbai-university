    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    <h4 class="heading"><strong>Subject Page  </strong> <span></span></h4><br>
                    <?php
                    	include "connect.php";
						$query = "SELECT * FROM subject WHERE department='{$_SESSION['de']}' AND sem='{$_SESSION['eo']}'"; //You don't need a ; like you do in SQL
						$result = mysqli_query($connect,$query);
						echo "<font size='4' face='Arial'>";
						echo "<table id='tabsub' border='2'>"; // start a table tag in the HTML
						echo "<tr><th>Sub Name</th><th>Shortcode</th><th>Theory hrs</th><th>Prac hrs</th><th>Tut hrs</th><th>Elective? (1=yes & 0=no)</th><th>Sub Year</th><th></th><th></th></tr>";
						while($row = mysqli_fetch_array($result))
                        {   //Creates a loop to loop through results
						echo "<tr><td>" . $row['subnm'] . "</td><td>" . $row['subsn'] . "</td><td><center>" . $row['subth'] . "</center></td><td><center>" . $row['subpr'] . "</center></td><td><center>" . $row['subtu'] . "</center></td><td><center>" . $row['subelec'] . "</center></td><td><center>" . $row['subyear'] . "</center></td><td><center><a id='editbut' href='editsub.php?edit=".$row['subsn']."'>Edit</a></center></td><td><center><a id='delbut' href=delsub.php?subsn=".$row['subsn'].">Delete</a></center></td></tr>";  
						}
					...
					?>
                    <br>
                    <input type="submit" style="background-color: darkslategray;color: white;" class="btn btn-sucess" value="GO BACK" name="back" onclick="window.location.href='subject.php'" class="txt2">
