...
//$year = $_POST['val'];
$query = "SELECT * FROM storecarddetails WHERE semester='{$_SESSION['eoadmin']}' AND department='{$_SESSION['deadmin']}'";
...
while($rs = mysqli_fetch_array($result)){
        ?>
        <script>
    if(<?php echo $rs['card'] ?>.innerHTML.indexOf("<?php echo $teaprint ?>") !== -1){
