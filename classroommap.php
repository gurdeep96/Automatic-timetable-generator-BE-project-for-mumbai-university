    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    <h4 class="heading"><strong>Classroom Mapping  </strong> <span></span></h4><br>
                    <?php
                    	include "connect.php";
						...
						echo "<tr><th>Classroom Name</th><th>Subject Name</th><th>Teacher Name</th><th>Class Name</th><th>Period Type</th></tr>";
						while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
						echo "<tr><td>" . $row['crnm'] . "</td><td>" . $row['subnm'] . "</td><td><center>" . $row['teanm'] . "</center></td><td><center>" . $row['class'] . "</center></td><td>" . $row['lectype'] . "</td></tr>";  
						}
					...
					?>
                    <br>
                    <input type="submit" style="background-color: darkslategrey;color:white" class="btn btn-primary" value="GO BACK" name="back" onclick="window.location.href='classroom.php'" class="txt2">
                </div>
            </div>
        </div>
    </div>
