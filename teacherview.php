        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    ...
                    <?php
                    	include "connect.php";
						$query = "SELECT * FROM teacher  WHERE department='{$_SESSION['de']}'"; //You don't need a ; like you do in SQL
						$result = mysqli_query($connect,$query);
						echo "<font size='5' face='Arial'>";
						echo "<table border='2'>"; // start a table tag in the HTML
						echo "<tr><th>Teacher Name</th><th>Shortcode</th><th></th><th></th></tr>";
						while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
						echo "<tr><td>" . $row['teanm'] . "</td><td>" . $row['teasn'] . "</td><td><center><a id='editbut' href='edittea.php?edit=".$row['teasn']."'>Edit</a></center></td><td><center><a id='delbut' href=deltea.php?teasn=".$row['teasn'].">Delete</a></center></td></tr>";  
						}
