...
{    }
    ...
    header("Location: login.php");
        ...
        if(isset($_GET['edit']))
        {
            $_SESSION['snm'] = $_GET['edit'];
            $query = "SELECT * FROM subject WHERE subsn='".$_SESSION['snm']."'";
        ...
        if(isset($_POST['newsubsn']))
        {
            $newname = $_POST['newsubnm'];
            $newcode = $_POST['newsubsn'];
            $th = $_POST['newsubth'];
            $pr = $_POST['newsubpr'];
            $tu = $_POST['newsubtu'];
            if(isset($_POST['newsubelec'])){
            $selec = $_POST['newsubelec'];
            }
            else{
                 $selec=0;
            }
            $year = $_POST['newsubyear'];
            $queryup = "UPDATE subject SET subnm='$newname',subsn='$newcode',subth='$th',subpr='$pr',subtu='$tu',subelec='$selec',subyear='$year' WHERE subsn='".$_SESSION['snm']."'";
    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid" >
            <div class="col-md-4" style="width:100%;">         
                ...
                <div class="form_main">
                    <div class="form">
                        <form action="editsub.php" method="post" id="contactFrm" name="subjectform">
                        <b>Select the Year:</b><br>
                         &nbsp;&nbsp;&nbsp;  <select name="newsubyear">
                                                    <option value="fe" <?php if($options=="fe") echo 'selected="selected"'; ?>>FE</option>
                                                    <option value="se" <?php if($options=="se") echo 'selected="selected"'; ?>>SE</option>
                                                    <option value="te" <?php if($options=="te") echo 'selected="selected"'; ?>>TE</option>
                                                    <option value="be" <?php if($options=="be") echo 'selected="selected"'; ?>>BE</option>
                                              </select><br><br>
                    <div id="containers">
                    	<table id="subtable">
                    	<tr>
                    		...
                    		<td><center>Elective or not</center></td>
                    	</tr>
                    	<tr>
                    		<td><input type="text" id="subnm" name="newsubnm" value="<?php echo $row[0] ?>" required></td>
                    		<td><input type="text" id="subsn" name="newsubsn" value="<?php echo $row[1] ?>" required></td>
                    		<td><input type="number" id="subth" name="newsubth" value="<?php echo $row[2] ?>"></td>
                    		<td><input type="number" id="subpr" name="newsubpr" value="<?php echo $row[3] ?>"></td>
                    		<td><input type="number" id="subtu" name="newsubtu" value="<?php echo $row[4] ?>"></td>
                    		<td><center><input type="checkbox" name="newsubelec" id="elective" value="1" <?php echo  ($cbox=='1')?'checked':'unchecked'; ?> ></center></td>
                    	</tr>
                  ...
                  <br>
                    	<div id="demo"></div>
                         ...
                         <input style="background-color: orangered;color: white" type="submit" class="btn btn-primary" value="Update" name="update" class="txt">
                             &nbsp;&nbsp;<input style="background-color: darkslategray;color: white" type="submit" class="btn btn-primary" value="Go Back" name="back" onclick="window.location.href='subjectview.php'" class="txt2">
