...
<div class="left-sidebar-pro" style="background-color: darkslategray">
        <nav id="sidebar"  style="background-color: darkslategray">
    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid" >
            <div class="col-md-4" style="width:100%;">         
                <header><h4 class="heading"><strong> Subject </strong> Page <span></span></h4></header>
                <div class="form_main">
                    <div class="form">
                    <br>
                        <form action="insertsubject.php" method="post" id="contactFrm" name="subjectform">
                        <b>Select the Year:</b><br>
                         &nbsp;&nbsp;&nbsp;  <select id="dd" name="subyear">
                    ...
                    <div id="containers">
                    	<table style="font-style: ariel"id="subtable">
                    	<tr>
                    		<td><center>Subject Name</center></td>
                    		<td><center>Subject shortcode</center></td>
                    		<td><center>Theory hours/week</center></td>
                    		<td><center>Practical hours/week</center></td>
                    		<td><center>Tutorial hours/week</center></td>
                    		<td><center>Elective?</center></td>
                    	</tr>
                    	<tr>
                    		<td><input type="text" id="subnm" name="subnm[]" value="" required></td>
                    		<td><input type="text" id="subsn" name="subsn[]" value="" required></td>
                    		<td><input type="number" id="subth" name="subth[]" value="0"></td>
                    		<td><input type="number" id="subpr" name="subpr[]" value="0"></td>
                    		<td><input type="number" id="subtu" name="subtu[]" value="0"></td>
                    		<td><center><input type="checkbox" name="subelec[]" id="elective" value="0" onclick="if(this.checked){document.getElementById('elective2').checked=false;}" checked> &nbsp;No<br><input type="checkbox" name="subelec[]" id="elective2" onclick="if(this.checked){document.getElementById('elective').checked=false;}" value="1"> Yes</center></td>
                    	</tr>
                    ...
                    <br>
                        ...
                        <input type="submit" style="background-color: gainsboro;color: black;width: 10%;" class=" btn btn-primary btn-block" onclick="addFields0()" value="Insert row">

                        <input type="submit" style="background-color: gainsboro;color: black;width: 10%;" class=" btn btn-primary btn-block" onclick="delFields0()" value="Delete row">

                        <br>
                        
                        <input style="background-color: gainsboro;color: black;width: 10%;" class=" btn btn-primary btn-block"type="submit" name="submit" value="ADD" class="txt2">
                        <br>

                        <input style="background-color: gainsboro;color: black;width: 10%;" class=" btn btn-primary" type="value" onclick="window.location.href='subjectview.php'" value="View">

                        <input style="background-color: gainsboro;color: black;width: 10%;" class=" btn btn-primary" type="submit" onclick="window.location.href='classroom.php'" value="Next">

                        <input style="background-color: orangered;color: black;width: 10%;" class=" btn btn-primary" type="submit" value="Mapping" name="mapping" onclick="window.location.href='subjectmap.php'" class="txt3">
