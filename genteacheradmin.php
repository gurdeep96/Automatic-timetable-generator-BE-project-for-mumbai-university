    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    <h4 class="heading"><strong>Faculty Timetable Page  </strong> <span></span></h4><br>
                    <div class="form">
                        <form target="_blank" action="generate_teacheradmin.php" method="post" id="genteaFrm" name="teattform">
                            <br>
                            ...
                            &nbsp;&nbsp;&nbsp;  <select name ="teachernameadmin" required>
                            <option disabled selected value>--- Select an option ---</option>
                            <?php 
