    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    <h4 class="heading"><strong>Period Mapping  </strong> <span></span></h4><br>
                    <?php
                    	include "connect.php";
						...
						echo "<tr><th>Teacher Name</th><th>Subject Name</th><th>Class</th><th>ClassRoom Name</th><th>Period Type</th><th></th><th></th></tr>";
						while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
						echo "<tr><td>" . $row['teanm'] . "</td><td>" . $row['subnm'] . "</td><td><center>" . $row['class'] . "</center></td><td><center>" . $row['crnm'] . "</center></td><td>" . $row['lectype'] . "</td><td><center><a id='editbut' href='editlec.php?teanm=".$row['teanm']."?subnm=".$row['subnm']."'>Edit</a></center></td><td><center><a id='delbut' href=dellec.php?teanm=".$row['teanm']."&subnm=".$row['subnm'].">Delete</a></center></td></tr>";  
						}

						echo "</table>"; //Close the table in HTML
						mysqli_close($connect);
					?>
                  <input type="submit"style="background-color: darkslategrey;color: white" class="btn btn-primary" value="GO BACK" name="back" onclick="window.location.href='lecture.php'" class="txt2">
                </div>
            </div>
        </div>
    </div>
