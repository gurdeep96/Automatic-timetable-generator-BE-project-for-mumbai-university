    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    <h4 class="heading"><strong>Faculty-wise Timetable Page  </strong> <span></span></h4><br>
                    <div class="form">
                        <form target="_blank" action="generate_teacher.php" method="post" id="genteaFrm" name="teattform">
                            <br><br><br>
                            <strong>Select Faculty Name:</strong><br><br>
                            ...
                            <input style="background-color: orangered;color: whitesmoke" class=" btn  btn-success loginbtn" type="submit" value="submit" class="txt2">
