...
if(isset($_POST['batnum']) & isset($_POST['evenodd'])){
$_SESSION['ba']=$_POST['batnum'];
$_SESSION['eo']=$_POST['evenodd'];
}
 ?>
<!doctype html>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul  style="background-color: darkslategray" class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <li><a title="View-All" href="genteacher.php" target=""><i class="" aria-hidden="true"></i> <span class="mini-sub-pro">Faculty Timetable &#8594;</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-4" style="width:100%;">
                <div class="form_main">
                    <h4 class="heading"><strong>Settings Page  </strong> <span></span></h4><br>
                    <div class="form">
                        <form action="#" method="post" id="contactFrm" name="teacherform">
                            <strong>Enter Total number of batches:</strong><br><br>
                            &nbsp;&nbsp;&nbsp;  <input type="number" name="batnum" value="4" min="1"> <br><br>
                            ...
                            <input style="background-color: gainsboro;color: black;width:7% " class="btn btn-default" type="Next" onclick="window.location.href='subject.php'" value="Next"><br><br>
                        </form>
                    </div>
                </div>
            </div>
